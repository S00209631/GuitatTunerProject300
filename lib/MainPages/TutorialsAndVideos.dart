...
class _SliderScreenState extends State<SliderScreen> {
  List imageList = [
    ...
    },
    {
      ...
      "link": 'https://yousician.com/lp/guitar?utm_source=google&utm_campaign=Yousician%20-%20Non%20Brand%20-%20Instrument%20-%20Guitar%20-%20Tier%202&utm_medium=cpc&utm_term=free%20online%20guitar%20lessons&gclid=Cj0KCQiAx6ugBhCcARIsAGNmMbjbV0N4kfbjc9zFtdcCaXQJ-P0CpzwTyMGoJC93TadQnVqQ5jsOxlYaAjWlEALw_wcB'
    }
  ];
  ...
  Widget build(BuildContext context) {
    ...
    color: currentIndex == index ? Colors.purpleAccent : Colors.grey,
    ),
    );
    }).toList(),
    ),
